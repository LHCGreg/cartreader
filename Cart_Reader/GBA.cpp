...
//   }
//   else {
//     ui->printErrorAndAbort(F("Unknown type"));
//   }
// }
...
//           }
//           else {
//             ui->printErrorAndAbort(F("Unknown size"));
//           }
...
//           // 4K EEPROM
//           writeEeprom_GBA(4);
//           uint32_t writeErrors = verifyEEP_GBA(4);
//           if (writeErrors == 0) {
...
//           // 64K EEPROM
//           writeEeprom_GBA(64);
//           uint32_t writeErrors = verifyEEP_GBA(64);
//           if (writeErrors == 0) {
//             ui->printlnMsg(F("Verified OK"));
//             ui->flushOutput();
//           }
...
//           uint32_t writeErrors = verifySRAM_GBA(32768, 0);
//           if (writeErrors == 0) {
//             ui->printlnMsg(F("Verified OK"));
//             ui->flushOutput();
//           }
...
//           uint32_t writeErrors = verifySRAM_GBA(65536, 0);
//           if (writeErrors == 0) {
//             ui->printlnMsg(F("Verified OK"));
//             ui->flushOutput();
//           }
...
// uint32_t verifySRAM_GBA(unsigned long sramSize, uint32_t pos) {
//   //open file on sd card
//   if (myFile.open(filePath, O_READ)) {
//     // Variable for errors
...
// uint32_t verifyFRAM_GBA(unsigned long framSize) {
//   // Output a HIGH signal on CS_ROM(PH3) WE_SRAM(PH5)
//   PORTH |= (1 << 3) | (1 << 5);
...
// // Check if the SRAM was written without any error
// uint32_t verifyEEP_GBA(word eepSize) {
//   uint32_t writeErrors = 0;
