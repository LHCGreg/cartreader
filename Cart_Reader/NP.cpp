...
//           ui->printlnMsg(F(""));
//           ui->printErrorAndAbort(F("Powercycle SFM cart"));
//         }
//       }
...
//         String outputFilename = F("SFM");
//         outputFilename.concat(foldern);
//         outputFilename.concat(F(".bin"));
//         sd.mkdir("NP", true);
//         sd.chdir("NP");
...
//           }
//           else {
//             ui->printErrorAndAbort(F("Error: Wrong Flash ID"));
//           }
//         }
//         else {
//           ui->printErrorAndAbort(F("Error: Wrong Flash ID"));
...
// uint32_t verifyFlash_SFM(int startBank, uint32_t pos) {
//   uint32_t verified = 0;
...
//       display_Update();
//       uint32_t writeErrors = verifyFlash_SFM(startBank, pos);
//       if (writeErrors == 0) {
//         println_Msg(F("OK"));
//         display_Update();
//       }
